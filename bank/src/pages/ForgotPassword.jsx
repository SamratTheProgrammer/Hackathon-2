...
const ForgotPassword = () => {
    ...
    return (
        <motion.div
            ...
            exit={{ opacity: 0 }}
        >
            <Link to="/login" className="inline-flex items-center text-gray-500 hover:text-gray-900 mb-6 text-sm">
                    ...
                    <div className="flex gap-4 justify-center my-6">
                        {[1, 2, 3, 4].map((_, i) => (
                            <input
                                ...
                                type="text"
                                maxLength="1"
                                className="w-12 h-12 text-center text-xl font-bold bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
                            />
                        ))}
                    </div>
